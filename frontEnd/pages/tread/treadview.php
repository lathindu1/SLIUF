...
<head>
    ...
    <script src="js/opentreadlist.js"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="../profile/profile.php">Profile
                        </a>
                    </li>
                    <li class="active">
                        <a href="#">Tread list
        ...
        <div class="row">
            <div class="col-sm-3 well">
                <div class="well">
                    ...
                    <img src="../../img/profilepics/142000.png" class="img-circle" height="80" width="80" alt="Avatar">
                </div>
                <div class="well">
